<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FAQ.aspx.cs" Inherits="ramly.FAQ" %>
...
<div class="header-section" style="background: url(Images/gymequipment.jpeg);">
    <h1>FAQ</h1>
  </div>
    ...
    <section id="accordion">
      <a class="py-3 d-block h-100 w-100 position-relative z-index-1 pr-1 text-secondary border-top" aria-controls="faq-17" aria-expanded="false" data-toggle="collapse" href="#faq-17" role="button">
        <div class="position-relative">
          <h2 class="h4 m-0 pr-3">
            Does Vision Fitness have a physical location?
          </h2>
      ...
      <div class="collapse" id="faq-17" style="">
        <div class="card card-body border-0 p-0">
          <p>We do not have a physical location at the moment but we have plans of opening an office for faster development</p>
      ...
      <div class="collapse" id="faq-18" style="">
        <div class="card card-body border-0 p-0">
          <p>Our official mission statement is to promote health and fitness by providing fitness related materials. Enable young generations to engage with activities.</p>
          <p>
          </p>
        </div>
      </div>
      ...
      <a class="py-3 d-block h-100 w-100 position-relative z-index-1 pr-1 text-secondary border-top" aria-controls="faq-19" aria-expanded="false" data-toggle="collapse" href="#faq-19" role="button">
        <div class="position-relative">
          <h2 class="h4 m-0 pr-3">
            Can I share membership accounts?
          </h2>
          <div class="position-absolute top-0 right-0 h-100 d-flex align-items-center">
            <i class="fa fa-plus"></i>
          </div>
      ...
      <div class="collapse" id="faq-19" style="">
        <div class="card card-body border-0 p-0">
          <p>No, sharing of member accounts is strictly pohibited. Additionaly, Vision Fitness wishes to further taylor your experience based on your calculated activities in Vision Fitness.</p>
          <p>
          </p>
        </div>
      </div>
      ...
      <div class="collapse" id="faq-20">
        <div class="card card-body border-0 p-0">
          <p>For general inquiries, you can email info.visfit@gmail.com</p>
          <p>
          </p>
        </div>
      </div>
      ...
      <div class="collapse" id="faq-21">
        <div class="card card-body border-0 p-0">
          <p>Check our 'About' page and learn more about us!</p>
          <p>
          </p>
        </div>
      </div>
      ...
      <a class="py-3 d-block h-100 w-100 position-relative z-index-1 pr-1 text-secondary  border-top" aria-controls="faq-22" aria-expanded="false" data-toggle="collapse" href="#faq-22" role="button">
        <div class="position-relative">
          <h2 class="h4 m-0 pr-3">
            Can teenagers under age 18 be a VisFit member?
          </h2>
          <div class="position-absolute top-0 right-0 h-100 d-flex align-items-center">
            <i class="fa fa-plus"></i>
          </div>
      ...
      <div class="collapse" id="faq-22">
        <div class="card card-body border-0 p-0">
          <p>Users under the age of 15 have to be registered under a parental guidance.</p>
          <p>
          </p>
        </div>
      </div>
